...
import "../static/views/ProfileEditor.css";
...
class ProfileEditor extends Component {
  ...
  // onLogout = e => {
  //   UserService.logOut().then(response => this.props.history.push("/")).catch(error => console.log(error));
  // };
          ...
          <div className="mt-4">
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-1">
                <img style={{ height: 40 }} src={this.state.photo} />
              </div>
